#!/bin/bash
# add-commands-to-poky-container.sh
# A simplified version of add-commands-to-container.sh focused on CROPS/poky containers
#
...
#
# Usage: add-commands-to-poky-container.sh CONTAINER_NAME
CONTAINER_NAME="$1"
