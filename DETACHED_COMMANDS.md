...
## Shared Approach for ROS2 and Yocto Containers

We've implemented a shared utilities approach that works consistently for both ROS2 and Yocto containers.
The utilities handle detached commands reliably, ensuring containers don't unexpectedly stop.
...
The ROS2 container includes multiple keep-alive mechanisms to ensure it stays running:
